                        ...
                        <article class="dashboard__article">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td><a class="update__btn" href="/admin/updatereview/<?= $review->id_review ?>">Accepter</a></td>
                                    <td><a class="delete__btn" href="/admin/deletereview/<?= $review->id_review ?>">Delete</a></td>
                                </tr>
                            </table>
                        </article>
                    <?php endif; ?>
